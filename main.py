...
def main():
    ...
    parser.add_argument("-n", "--number-of-folder", type=int, default=0, help="Number of folder.")
    ...
    process_videos_in_folder(original_folder_path, destination_folder_path_frames, threshold)
